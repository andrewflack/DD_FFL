...
# Input is a dataframe containing seven variables: (1) a numeric vector denoting the time period in which the matchup
# took place (2) character identifier for owner one (3) a character identifier for owner two (4) the result of the 
# matchup expressed as a number (1 for owner win, 0 for owner loss, .5 for tie) (5) margin of victory (owner - 
# opp_owner) (6) binary flag if "owner" is a new owner (7) binary flag if period is the start of a new season

"ddffl_elo" <- function(x, init=1500, k=20)
{
