# Function to generate reports from rmd files
# Source: https://github.com/jomuller/empty_project/blob/master/functions/make_reports.R

knitr::opts_knit$set(root.dir = '../.')

report <- function(rmd, n_file, open_file = FALSE,
